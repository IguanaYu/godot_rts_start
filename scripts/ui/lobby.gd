...
func _build_ui():
	...
	_ready_btn.anchor_top = 0.48
	_ready_btn.anchor_bottom = 0.56
	_ready_btn.pressed.connect(_on_ready_pressed)
	_ready_btn.visible = not RelayManager.is_host
	...
	_start_btn.anchor_top = 0.48
	_start_btn.anchor_bottom = 0.56
	_start_btn.pressed.connect(_on_start_pressed)
	_start_btn.visible = RelayManager.is_host
