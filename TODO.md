...
- **[P0] T3 阶段设计 - 生成技术设计文档** #设计 #t3 #技术设计
  T3 各模块决策稿已聊完（A 经济推演 / C 候选库+决策稿 / E F G H I 决策稿）。下一步把每个模块的设计决策对照现有代码结构，落成可指导实现的技术设计文档（涉及哪些脚本、新加哪些类/信号、数据流如何接、改动顺序）。
  关联: [T3阶段设计_A模块经济推演.md](docs/active/T3阶段设计_A模块经济推演.md), [T3阶段设计_C模块决策稿.md](docs/active/T3阶段设计_C模块决策稿.md), [T3阶段设计_C模块设计候选库.md](docs/active/T3阶段设计_C模块设计候选库.md), [T3阶段设计_E模块决策稿.md](docs/active/T3阶段设计_E模块决策稿.md), [T3阶段设计_F模块决策稿.md](docs/active/T3阶段设计_F模块决策稿.md), [T3阶段设计_G模块决策稿.md](docs/active/T3阶段设计_G模块决策稿.md), [T3阶段设计_H模块决策稿.md](docs/active/T3阶段设计_H模块决策稿.md), [T3阶段设计_I模块决策稿.md](docs/active/T3阶段设计_I模块决策稿.md)
  创建: 2026-08-11
